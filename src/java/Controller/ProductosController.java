...
public class ProductosController extends HttpServlet {
	...
	switch (action) {
		...
		producto = productosDao.obtenerProductoPorFolio(NumProd);
		...
		// Redirigir a la página de modificación
		rd = request.getRequestDispatcher("/ProductoDetalle.jsp");
		rd.forward(request, response);
		break;
	    default:
	...
	String productoAbuscar = request.getParameter("query");

	ProductoDao pla = new ProductoDao();
	List<Producto> todas = new LinkedList<>();
	todas = pla.buscarProductos(productoAbuscar);
